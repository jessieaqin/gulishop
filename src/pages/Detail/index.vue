...
export default {
  ...
  methods: {
    getDeatailInfo() {
      this.$store.dispatch("getDeatailInfo", this.skuId);
    },
    changeCheck(spuSaleAttrValueList, AttrValue) {
