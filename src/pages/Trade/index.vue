  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      >
        ...
        >
        <p @click="changeAddress(addressList, address)">
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="(order, index) in detailArrayList"
          :key="index"
        >
          <li>
            <img
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>北{{ selectAddress.fullAddress }}</span>
...
export default {
  ...
  computed: {
    ...
    ...mapGetters(["detailArrayList", "tradeInfo"]),
    selectAddress() {
  ...
  methods: {
    ...
    //点击修改默认地址(排他)
    changeAddress(addressList, address) {
    ...
    async submitOrder() {
      ...
      const result = await this.$API.reqSubmitOrder(traderNo, orderInfo);
      if (result.code == 200) {
        this.$message({
          message: "订单创建成功，准备去往支付页面",
          type: "success",
        });
